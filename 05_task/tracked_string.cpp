...
TrackedString::TrackedString() : id(++count) {
    Logger::getInstance("../../logs/task_05.log").log(
...
TrackedString& TrackedString::operator=(const TrackedString& other) {
    value = other.value;
    Logger::getInstance("../../logs/task_05.log").log(
        std::format("[operator=] id={} from id={}", id, other.id),
        Logger::Level::INFO);
    return *this;
}
...
bool operator==(const TrackedString& a, const TrackedString& b) {
    ...
    Logger::getInstance("../../logs/task_05.log").log(
        std::format("[operator==] id1={} id2={} result={}", a.id, b.id, result),
        Logger::Level::INFO);
    return result;
}
bool operator!=(const TrackedString& a, const TrackedString& b) {
...
TrackedString operator+(const TrackedString& a, const TrackedString& b) {
    Logger::getInstance("../../logs/task_05.log").log(
        std::format("[operator+] id1={} id2={}", a.id, b.id),
        Logger::Level::INFO);
